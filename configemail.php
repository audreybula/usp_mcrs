...
$PAGE->navbar->add(get_string('block_configemail', 'block_usp_mcrs'));
$PAGE->set_url('/blocks/usp_mcrs/configemail.php');
$PAGE->set_context(context_system::instance());
$PAGE->set_heading(get_string('block_configemail', 'block_usp_mcrs'));
$PAGE->set_title(get_string('block_configemail', 'block_usp_mcrs'));
