...
$header = get_string('build_search', 'block_usp_mcrs');
...
echo html_writer::tag('div', '', array(
    'id' => 'results_error', 'class' => 'usp_mcrs_error'
));
...
$controls = html_writer::tag('div',
    get_string('match', 'block_usp_mcrs') .
    html_writer::select(array_combine($options, $options), 'type', 'ALL', null) .
    get_string('of_these_constraints', 'block_usp_mcrs') .
...
$options = array(
    ...
    get_string('course_id', 'block_usp_mcrs'), get_string('category')
);
...
$options = array(
    get_string('is', 'block_usp_mcrs'),
    get_string('is_not', 'block_usp_mcrs'),
    get_string('contains', 'block_usp_mcrs'),
    get_string('does_not_contain', 'block_usp_mcrs'));
...
$button = html_writer::tag('div',
    html_writer::empty_tag('input', array(
        'type' => 'submit', 'value' => get_string('build_search_button', 'block_usp_mcrs')
    )), array('id' => 'button')
);
